...
<body style="height:100% ; width:100%;background-color: rgb(100, 136, 145)" >
    <form id="form1" runat="server" style=" height:100%; ">
        ...
        <div>
            <asp:SqlDataSource ID="SqlDataAvCourses" runat="server"  ConnectionString="<%$ ConnectionStrings:GUCera %>" SelectCommand="availableCourses" SelectCommandType="StoredProcedure">
                <SelectParameters>
       ...
       <asp:Panel ID="Panel6" runat="server"  CssClass="auto-style19" Height="341px" ScrollBars="Vertical" style="margin-top: 0px">
        ...
        <asp:GridView ID="gridCourses" runat="server" BackColor="White" BorderColor="#CCCCCC" 
            BorderStyle="None" BorderWidth="1px" CellPadding="3" Font-Size="13"
            Height="125px"  Width="426px" AutoGenerateColumns="False" DataSourceID="SqlDataAvCourses" >
            <Columns>
