<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InsAccept.aspx.cs" Inherits="GUCera.InsAccept" %>
...
<body style="height:100% ; width:100%;background-color: rgb(100, 136, 145)" >
    <form id="form1" runat="server" style=" height:100%; ">
        ...
        <asp:GridView ID="gridCourses" runat="server" BackColor="White" BorderColor="#CCCCCC" 
            ...
            Height="125px"  Width="577px" AutoGenerateColumns="False" DataSourceID="SqlDataAccptCourses" DataKeyNames="id"   >
            <Columns>
