...
<body style="height:100% ; width:100%;background-color:rgb(7, 30, 36)" >
    <form id="form1" runat="server" autocomplete="off">
        <div style="height:220px" class="auto-style1">
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="GoToLogIn" runat="server" OnClick="Login_Click"  Text="LOG IN" BackColor="Transparent" BorderStyle="None" Font-Names="SansSerif"  Height="24px" Width="166px" CausesValidation="false" CssClass="h" />

            <asp:Label ID="Label2" runat="server" Font-Names="SansSerif" Font-Size="15pt" Font-Underline="True" Text="SIGN UP As Student" ForeColor="White"></asp:Label>

            <asp:Button ID="InstructorRegister" runat="server" OnClick="InstructorRegister_Click" Text="SIGN UP As Instructor" BackColor="Transparent" BorderStyle="None" Font-Names="SansSerif" Height="24px" Width="189px" CausesValidation="false" CssClass="h" />
